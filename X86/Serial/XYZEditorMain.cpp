...
XYZEditorFrame::XYZEditorFrame(wxWindow* parent,wxWindowID id)
{
    ...
    Create(parent, wxID_ANY, _("XYZEditor Serial"), wxDefaultPosition, wxDefaultSize, wxDEFAULT_FRAME_STYLE, _T("wxID_ANY"));
    {
    	wxIcon FrameIcon;
